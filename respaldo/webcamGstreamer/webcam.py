...
PIPELINE_DESC_H264 = '''
webrtcbin name=sendrecv latency=0 stun-server=stun://stun.l.google.com:19302
 v4l2src device=/dev/video0 ! queue ! v4l2convert ! video/x-raw,format=I420,width=640,height=480,framerate=30/1 !
  v4l2h264enc ! h264parse ! video/x-h264,stream-format=byte-stream,alignment=au,width=640,height=480,framerate=30/1,profile=baseline,level=(string)4 !
...
if __name__ == '__main__':
    ...
    parser.add_argument('--video-encoding', default='h264', nargs='?', choices=['vp8', 'h264', 'av1'],
